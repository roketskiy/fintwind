...
const SESSION_KEY = 'fintwind.remote.session.v1'
const PERSISTENT_KEY = 'fintwind.remote.persistent.v1'
...
export function normalizeDaemonAddress(
  ...
  if (
    ...
    throw new Error(t?.('web.error_secure_websocket_required') ?? 'A secure Fintwind Web page can only connect through wss://')
  }
