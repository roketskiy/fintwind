...
import { FintwindClient } from '@fintwind/client'
import {
  createContext,
  useCallback,
  useContext,
...
export function DaemonProvider({ children }: { children: ReactNode }) {
  ...
  const [client, setClient] = useState<FintwindClient | null>(null)
