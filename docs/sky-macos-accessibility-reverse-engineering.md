...
This is the critical path for Fintwind parity.
...
## Why Fintwind's previous approximation failed
...
## Compatibility requirements for Fintwind
...
1. Codex/Fintwind remains the actual frontmost application throughout.
