//! Immutable, render-ready Git diffs for Fintwind's Review surface.
//!
...
pub fn wire_source(source: Source) -> fintwind_client::workspace::ReviewDiffSource {
    match source {
        Source::LastTurn {
            session_id,
            turn_id,
            turn_count,
        } => fintwind_client::workspace::ReviewDiffSource::LastTurn {
            session_id,
            turn_id,
            turn_count,
        },
        Source::Uncommitted => fintwind_client::workspace::ReviewDiffSource::Uncommitted,
        Source::Unstaged => fintwind_client::workspace::ReviewDiffSource::Unstaged,
        Source::Staged => fintwind_client::workspace::ReviewDiffSource::Staged,
        Source::Committed => fintwind_client::workspace::ReviewDiffSource::Committed,
        Source::Branch => fintwind_client::workspace::ReviewDiffSource::Branch,
    }
}
